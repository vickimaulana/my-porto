...
// skill
$querySkill = mysqli_query($koneksi, "SELECT * FROM skills ORDER BY id DESC");
$rowSkill  = mysqli_fetch_assoc($querySkill);

// setting
$querySetting = mysqli_query($koneksi, "SELECT * FROM settings ORDER BY id DESC");
$rowSetting  = mysqli_fetch_assoc($querySetting);

//penilaian
$queryTestimonials = mysqli_query($koneksi, "SELECT * FROM testimonials ORDER BY id DESC");
$rowTestimonials  = mysqli_fetch_assoc($queryTestimonials);
