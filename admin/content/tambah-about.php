            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Tentang Diri</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="birthday" required value="<?= $rowEdit['birthday'] ?? '' ?>">
                        </div>

                        <div class="mb-3">
                            <label>Website</label>
                            <input type="text" class="form-control" name="website" required value="<?= $rowEdit['website'] ?? '' ?>">
                        </div>

                        <div class="mb-3">
                            <label>Phone</label>
                            <input type="text" class="form-control" name="phone" required value="<?= $rowEdit['phone'] ?? '' ?>">
                        </div>

                        <div class="mb-3">
                            <label>Alamat</label>
                            <input type="text" class="form-control" name="city" required value="<?= $rowEdit['city'] ?? '' ?>">
                        </div>

                        <div class="mb-3">
                            <label>Umur</label>
                            <input type="text" class="form-control" name="age" required value="<?= $rowEdit['age'] ?? '' ?>">
                        </div>

                        <div class="mb-3">
                            <label>Pendidikan Terakhir</label>
                            <input type="text" class="form-control" name="degree" required value="<?= $rowEdit['degree'] ?? '' ?>">
                        </div>

                        <div class="mb-3">
                            <label>Email</label>
                            <input type="text" class="form-control" name="email" required value="<?= $rowEdit['email'] ?? '' ?>">
                        </div>

                        <div class="mb-3">
                            <label>Status Pekerjaan</label>
                            <select class="form-control" name="freelance_status" required>
                                <option value="">-- Pilih Status --</option>
                                <option value="Available" <?= (isset($rowEdit['freelance_status']) && $rowEdit['freelance_status'] == 'Available') ? 'selected' : '' ?>>Available</option>
                                <option value="Not Available" <?= (isset($rowEdit['freelance_status']) && $rowEdit['freelance_status'] == 'Not Available') ? 'selected' : '' ?>>Not Available</option>
                            </select>
                        </div>
